...
public class TagInfoDto implements Serializable {
    ...
    public TagInfoDto(String name, String currencyCode) {
    ...
    public void checkResult(BigDecimal cashExpected) throws ValidationException {
        BigDecimal result = getCash();
        if(result.compareTo(cashExpected) != 0) throw new ValidationException("currency '" +
