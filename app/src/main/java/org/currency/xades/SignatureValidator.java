...
public class SignatureValidator {
    ...
    public XmlSignature validate(Element signatureElement) throws Exception {
        ...
        result.setTimeStampDate(getTimeStampDate(qualifyingProperties.getElement(XAdESUtils.XADES_NAMESPACE, "UnsignedProperties")));
        ...
        byte[] signatureValueBytes = org.bouncycastle2.util.encoders.Base64.decode(((String) signatureValue.getChild(0)).getBytes());
        ...
        if(unsignedPropertiesElement != null) {
            ...
            if(unsignedSignaturePropertiesElement != null) {
                ...
                if(signatureTimeStampElement != null) {
                    ...
                    byte[] timeStamp = org.bouncycastle2.util.encoders.Base64.decode(base64TimeStamp);
    ...
    public static class ReferenceDigestData {
        ...
        public void checkDigest(byte[] content) throws NoSuchAlgorithmException, ValidationException {
            ...
            byte[] digestBase64 = android.util.Base64.encode(digest, android.util.Base64.NO_WRAP);
            String calculatedDigest = new String(digestBase64);
