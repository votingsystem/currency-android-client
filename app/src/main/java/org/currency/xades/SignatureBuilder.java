...
import org.currency.crypto.MockDNIe;
...
public class SignatureBuilder {
     ...
     * - Hasn't empty tags (Replace self-closing tags)
     ...
     * @param timeStampServiceURL     p.e: http://voting.ddns.net/timestamp-server/api/timestamp
     * @throws IOException
    ...
    public SignatureBuilder(byte[] documentToSignBytes, String documentToSignMimeType,
            ...
            List<X509Certificate> signingCertificateChain, String timeStampServiceURL)
     ...
     */
    public SignatureBuilder(byte[] documentToSignBytes, String documentToSignMimeType,
            String signatureAlgorithm, MockDNIe mockDNIe, String timeStampServiceURL) throws IOException,
            ParseException {
        Security.addProvider(new BouncyCastleProvider());
        this.documentToSignBytes = documentToSignBytes;
        this.documentToSignMimeType = documentToSignMimeType;
    ...
    private Element buildSignatureValueElement() throws CertificateEncodingException, IOException,
        ...
        byte[] signedBytesEncoded = org.bouncycastle2.util.encoders.Base64.encode(signedBytes);
    ...
    private Element buildKeyInfoElement() throws CertificateEncodingException {
        ...
        for (X509Certificate certificate : signingCertificateChain) {
            ...
            X509CertificateElement.addChild(Node.TEXT, new String(Base64.encode(
                    certificate.getEncoded(), Base64.NO_WRAP)));
    ...
    private Element buildUnsignedProperties() throws Exception {
        ...
        if (timeStampServiceURL != null) {
            ...
            if (ResponseDto.SC_OK == response.getStatusCode()) {
                ...
                String encapsulatedTimeStampValue = Base64.encodeToString(timeStampToken.getEncoded(),
                        Base64.NO_WRAP);
                encapsulatedTimeStampElement.addChild(Node.TEXT, encapsulatedTimeStampValue);
