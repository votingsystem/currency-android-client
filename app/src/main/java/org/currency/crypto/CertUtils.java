...
public class CertUtils {
    ...
    public static PKIXCertPathValidatorResult verifyCertificate(X509Certificate certToCheck,
                                                                X509Certificate caCert) throws ExceptionBase {
    ...
    public static PKIXCertPathValidatorResult verifyCertificate(Set<TrustAnchor> anchors,
                                                                boolean checkCRL, List<X509Certificate> certs) throws ExceptionBase {
        return verifyCertificate(anchors, checkCRL, certs, Calendar.getInstance().getTime());
    }

    public static PKIXCertPathValidatorResult verifyCertificate(Set<TrustAnchor> anchors,
                                                                boolean checkCRL, List<X509Certificate> certs, Date signingDate) throws ExceptionBase {
        try {
            ...
            throw new ExceptionBase(msg, ex);
        }
    }

    public static String getCertExtensionData(X509Certificate x509Certificate,
