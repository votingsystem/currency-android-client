...
public class TransactionContentProvider extends ContentProvider {
    ...
    private static final String DB_NAME       = "transaction_content_provider.db";
    private static final String TABLE_NAME    = "transactionvs";
    public static final String AUTHORITY      = "currency.org.transaction";
    ...
    public static Uri addTransaction(Context context, TransactionDto transaction, String weekLapse){
    ...
    public static ContentValues getContentValues(TransactionDto transaction) {
        ...
        if(transaction.getFromUser() != null) values.put(
                TransactionContentProvider.FROM_USER_COL, transaction.getFromUser().getNumId());
        if(transaction.getToUser() != null) values.put(
                TransactionContentProvider.TO_USER_COL, transaction.getToUser().getNumId());
        ...
        values.put(TransactionContentProvider.TYPE_COL, transaction.getOperation().toString());
        try {
