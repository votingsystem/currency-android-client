...
public class MessageContentProvider extends ContentProvider {
    ...
    private static final String DB_NAME       = "message_content_provider.db";
    private static final String TABLE_NAME    = "message";
    public static final String AUTHORITY      = "currency.org.message";
    ...
    public static Uri insert(ContentResolver contentResolver, MessageDto socketMsg)
            throws IOException {
        String decryptedMsg = JSON.writeValueAsString(socketMsg);
        Uri result = contentResolver.insert(CONTENT_URI, getContentValues(
                socketMsg.getOperation().getType(), decryptedMsg, State.NOT_READED));
        ResponseDto responseDto = new ResponseDto().setOperationType(OperationType.MSG_TO_DEVICE)
    ...
    public static int countNumMessagesNotReaded() {
        ...
        //        STATE_COL + "=?", new String[]{AppState.NOT_READED.toString()});
