...
public class UserContentProvider extends ContentProvider {
    ...
    private static final String DB_NAME       = "user_content_provider.db";
    public static final String TABLE_NAME     = "user";
    public static final String AUTHORITY      = "currency.org.user";
    ...
    public static Uri getContactURI(String id) {
    ...
    public static ContentValues getContentValues(UserDto user) {
        ...
        values.put(UserContentProvider.FULL_NAME_COL, user.getFullName());
        ...
        values.put(UserContentProvider.NIF_COL, user.getNumId());
        return values;
    }
