...
import org.currency.crypto.ReceiptContainer;
...
public class ReceiptContentProvider extends ContentProvider {
    ...
    private static final String DB_NAME       = "receipt_content_provider.db";
    private static final String TABLE_NAME    = "receipt";
    public static final String AUTHORITY      = "currency.org.receipt";
    ...
    public static ContentValues getContentValues(Serializable receipt, OperationType operationType,
                         ReceiptContainer.State state) {
        ContentValues values = new ContentValues();
        values.put(SERIALIZED_OBJECT_COL, ObjectUtils.serializeObject(receipt));
        values.put(TYPE_COL, operationType.name());
