...
public class Constants {
    ...
    public static final String DEFAULT_CURRENCY_SERVER = "https://voting.ddns.net/currency-server";
    ...
    public static final String CERT_REQUEST_KEY      = "CERT_REQUEST_KEY";
    ...
    public static final String WALLET_FILE_NAME = "WALLET_FILE_NAME_KEY";
    ...
    public static final String REVOCATION_HASH               = "REVOCATION_HASH";
