...
public class IntentIntegrator {
    ...
    public final AlertDialog initiateScan(Collection<String> desiredBarcodeFormats, Context context) {
        title = context.getString(R.string.app_needed_caption);
        message = context.getString(R.string.app_needed_msg);
        buttonYes = context.getString(R.string.continue_lbl);
        buttonNo = context.getString(R.string.cancel_lbl);
        return initiateScan(desiredBarcodeFormats, -1);
    }
